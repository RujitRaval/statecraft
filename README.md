...
The workspace currently contains `packages/core`, `packages/runner-playwright`, `packages/report`, and `packages/cli`. The example application package is added when its implementation phase begins.
