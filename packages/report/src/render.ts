...
const styles = `
:root{color-scheme:dark;--bg:#090b10;--panel:#11151d;--panel-2:#171c26;--line:#293140;--text:#f4f7fb;--muted:#9aa6b8;--accent:#8a7dff;--accent-2:#39d6b4;--pass:#4ade80;--fail:#fb7185;font-family:"Avenir Next","Segoe UI Variable",Ubuntu,sans-serif}
