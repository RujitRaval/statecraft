...
Statecraft has completed Phase 1 through Phase 5. Phase 6 is active, with the example-app foundation plus the dashboard and orders state surfaces complete. Keep customer detail, intentional defects, the complete scenario matrix, and Phase 7 in focused follow-ups until the user explicitly advances them. Read `AGENTS.md`, `codex/IMPLEMENTATION_SPEC.md`, and the relevant documents under `docs/` before changing code.
